...
test_sensors2 = [
    CircularPIRSensor("normal PIR", 0, 120, 140, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 1, 220, 140, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 2, 430, 120, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 3, 100, 55, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 4, 200, 55, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 5, 300, 45, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 6, 400, 45, constants.LIGHT_RED, 50),
    ...
    CircularPIRSensor("normal PIR", 13, 210, -140, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 14, 310, -140, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 15, 410, -140, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 16, 510, -140, constants.LIGHT_RED, 50),
    ...
    CircularPIRSensor("normal PIR", 20, 850, 85, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 21, 840, 10, constants.LIGHT_RED, 50),
    CircularPIRSensor("normal PIR", 22, 910, 40, constants.LIGHT_RED, 50),
